                ...
                <div className="text-center">
                    <FadeIn>
                        <div className="flex justify-center mb-8">
                            <div className="inline-flex items-center gap-2 bg-brand-gold/10 border border-brand-gold/20 backdrop-blur-sm px-6 py-2 rounded-full">
                    ...
                    <FadeIn delay={0.2} yOffset={20}>
                        <div className="flex flex-col sm:flex-row gap-2 md:gap-4 lg:gap-8 justify-center items-center mb-12">
                            <Button
                    ...
                    {/* Trust Indicators */}
                    <FadeIn delay={0.3}>
                        <div className="flex flex-wrap justify-center items-center gap-2 md:gap-4 lg:gap-8 text-sm text-white/50">
